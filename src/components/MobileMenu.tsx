                        ...
                        <nav className="flex flex-col gap-6 w-full max-w-xs px-6">
                            {scenes.map((scene, index) => (
                                <motion.button
                                    ...
                                    className="group flex items-center gap-4 w-full p-4 rounded-xl bg-white/5 active:bg-white/10 border border-white/5 transition-all text-left transform active:scale-98"
                                >
